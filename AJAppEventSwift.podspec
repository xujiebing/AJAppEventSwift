#
# Be sure to run `pod lib lint AJAppEventSwift.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'AJAppEventSwift/Classes/**/*'
  
  # s.resource_bundles = {
  #   'AJAppEventSwift' => ['AJAppEventSwift/Assets/*.png']
  # }
